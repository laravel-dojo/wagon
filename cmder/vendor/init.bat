...
@set PATH=%CMDER_ROOT%\bin;%php_install_root%;%COMPOSER_HOME%;%COMPOSER_HOME%\vendor\bin;%git_install_root%\bin;%git_install_root%\mingw\bin;%git_install_root%\cmd;%git_install_root%\share\vim\vim74;%CMDER_ROOT%;%PATH%
